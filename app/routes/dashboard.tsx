  ...
  return (
    <div className="min-h-screen relative">
      ...
      <main className="pt-28 pb-12 px-4 md:px-8 max-w-7xl mx-auto">
        {/* Welcome Banner */}
        <div className="mb-8 p-6 glass rounded-2xl border border-white/10 overflow-hidden relative">
        ...
        <footer className="mt-12 pt-8 border-t border-white/10 text-center">
          <div className="glass-dark rounded-2xl p-6 inline-block">
            <p className="text-gray-400 text-sm">
              Powered by <span className="text-blue-400 font-semibold">Blockchain</span> + <span className="text-purple-400 font-semibold">AI Analytics</span>
            </p>
            <div className="flex items-center justify-center gap-6 mt-4">
              <a href="https://github.com/The-ChandanKV/ChainSight" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors">
              ...
              <p className="text-gray-500 text-xs">© 2024 ChainSight. Built with ❤️</p>
            </div>
          </div>
        </footer>
      </main>
